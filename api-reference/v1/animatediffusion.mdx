...
<ParamField body="prompt" type="string" required>
  This is the text prompt for the video you want generated.
</ParamField>
...
<ParamField body="video_length" type="integer" required>
  Length of the video. `0-24` for `mm_sd_v14`, `mm_sd_v15` and `0-32` for `mm_sd_v15_v2`. Total length of the video will be determined by video_length / fps.
</ParamField>
