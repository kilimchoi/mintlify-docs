...
<ParamField body="prompt" type="string" required>
  This is the text prompt for the video you want generated. You can use loras to control the camera's direction. You can use lora by adding `<lora:LORA_NAME:weight>` at the front of your prompt. Here's a [list](/documentation/animate-diffusion-loras) of all the supported loras.
</ParamField>
