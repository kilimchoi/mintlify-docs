---
title: 'v1/sync/img2img'
api: 'POST https://randomseed.lol/v1/sync/img2img'
description: 'Generate an image from an image synchronously'
---
### Headers
...
<ParamField body="inpaint_full_res" type="boolean">
  If set to true, inpaint area will be the same resolution as the starting image. If set to false, inpaint area will stretch to fit the starting image. This parameter is required for inpainting.
</ParamField>
